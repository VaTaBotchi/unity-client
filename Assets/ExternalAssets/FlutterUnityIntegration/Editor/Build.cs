...
public class Build : EditorWindow
{
    ...
    private static void BuildIOS(String path)
    {
        ...
        PlayerSettings.iOS.cameraUsageDescription = "need camera";
        PlayerSettings.iOS.microphoneUsageDescription = "need mic";
        PlayerSettings.iOS.locationUsageDescription = "need location";
